...
public class ClientGUI extends JFrame implements ActionListener {
    ...
    final private JTextField tfServer, tfPort;
    // to Logout and get the list of the users
    final private JButton login, logout, whoIsIn;
    // for the chat room
    ...
    final private String defaultHost;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (connected) {
            if (o == tf) // just have to send the message
            {
    ...
    public static void main(String[] args) {
        ClientGUI cgui;
        cgui = new ClientGUI("162.243.55.81", 1500);
    }
